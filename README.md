...
- 📺 **[cueball](https://github.com/KikeCR/cueball)** ![Stars](https://img.shields.io/github/stars/KikeCR/cueball?style=flat&label=%E2%98%85&color=faf9f6) ![Top language](https://img.shields.io/github/languages/top/KikeCR/cueball?style=flat&color=3178C6) — a shared watch-party queue for YouTube: Next.js, Express, Socket.io, PostgreSQL/Prisma & Redis, where anyone in the room adds videos and votes on the queue live, with the host able to sync it to a real YouTube playlist (OAuth + Data API v3) to play natively on a TV.
